...
class PlanningNode(Node):
    def __init__(self):
        ...
        # Publish trajectories per agent
        ...
        # Timer para solicitar la planificacion inicial una vez que se reciben todas las posiciones
    ...
    def darp_callback(self, future):
        ...
        for i, traj in enumerate(response.trajectories):
            ...
            self.get_logger().info(
                f"Publicada trayectoria (len={len(msg.points)}) en /{agent_id}/plan/trajectory"
            )
